...
class MhsEvaluator(object):
    ...
    def eval_ner(self, print_level=1):
        ...
        self._ner_evaluator.print_results('ner', f1_mode=self.f1_mode, print_level=print_level)
    ...
    def eval_mod(self, print_level=1):
        ...
        self._mod_evaluator.print_results('mod', f1_mode=self.f1_mode, print_level=print_level)
    ...
    def eval_rel(self, print_level=1):
        ...
        self._rel_evaluator.print_results('rel', f1_mode=self.f1_mode, print_level=print_level)
