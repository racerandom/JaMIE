...
"""
parser = argparse.ArgumentParser(description='Clinical IE pipeline rel classifier')
...
if args.do_train:
    ...
    # train_pair_mask, train_pair_tag, train_rel, train_rel_tup, train_spo = utils.extract_pipeline_rel_from_mhs_conll_v2(
    ...
    dev_pair_mask, dev_pair_tag, dev_rel, dev_rel_tup, dev_spo = utils.extract_pipeline_rel_from_mhs_conll_v2(
